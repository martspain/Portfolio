...
const HomeFooter = () => {
  return (
    <div className="Footer-container" data-testid="FooterTest">
        ...
        <div className="container">
          <div className="row justify-content-center align-items-center">
            <div className="col-1 Footer-contact-itemI">
              <img className="Footer-icon" alt="LinkedIn" src={linkedin} />
            </div>
          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-1 Footer-contact-itemI">
              <img className="Footer-icon" alt="Mail" src={mail} />
            </div>
            <div className="col-5 Footer-contact-itemL">
              <h1 className="Footer-contact-item-title">
                Gmail
          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-1 Footer-contact-itemI">
              <img className="Footer-icon" alt="Github" src={cat} />
            </div>
            <div className="col-5 Footer-contact-itemL">
              <h1 className="Footer-contact-item-title">
                GitHub
          ...
          <div className="row justify-content-center align-items-center">
            <div className="col-1 Footer-contact-itemI">
              <img className="Footer-icon" alt="Phone" src={whats} />
            </div>
            <div className="col-5 Footer-contact-itemL">
              <h1 className="Footer-contact-item-title">
                WhatsApp
